                ...
                <div class="row mb-3">
                    <div class="col-12">
                        <div class="d-flex gap-2 flex-wrap">
                            ...
                            >
                                <i class="fas fa-times me-1"></i>Xóa tất cả bộ
                                lọc
                            </button>
                        </div>
                    </div>
                            ...
                            <tbody>
                                ...
                                >
                                    ...
                                    <td>
                                        <span
                                            :class="
                                                getRoleBadgeClass(user.role_id)
                                            "
                                        >
                                            <i
                                                :class="
...
export default {
    ...
    methods: {
        ...
        Adduser() {
            this.$router.push("/AddUserFarmer");
        },

        navigateToEditUser(userId) {
            this.$router.push(`/UserFarmerDetails/${userId}`);
        },
