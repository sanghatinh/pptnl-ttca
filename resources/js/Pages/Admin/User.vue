<template>
    ...
    <div>
        <!-- Desktop Controls -->
        <div class="desktop-controls-container" v-if="!isMobile">
                    ...
                    >
                        ...
                        >
                            <div class="user-index fw-bold">
                                <span
                                    class="badge bg-label-primary rounded-pill"
                                    >#{{
